...
import { FaCloud, FaShieldAlt, FaFlag, FaChartBar } from 'react-icons/fa';

import wave3 from '../../assets/wave2.svg'
import heroimage from './assets/hero/hero-background.jpg';
import robot2 from './assets/roadmap/image-2.png';
import curve from './assets/hero/curve.png'
import robot from './assets/hero/robot.jpg';
import sample from './assets/hero/sample.png';  
// import videobg2 from '../../assets/videobg2.mp4'
// import AnimatedBackground from './Animatedbg.jsx'
...
>
      ...
      <div ref={Homeref} id='Home' className="bg-transparent font-serif justify-center grid grid-cols-1 items-center text-center flex-col sm:px-4 md:px-8 lg:px-12">
  <div className='float-in-right'>
    <div className="text-white rounded-2xl"> {/* Removed shadow and border classes */}
      <h1 className="font-bold flex justify-center mt-[1rem] text-4xl sm:text-2xl md:text-3xl lg:text-4xl">Welcome</h1>
      ...
      <div className="flex justify-center">
        <span className="inline-block text-3xl relative">
          Sprinty
          <img
            src={curve} // Ensure the image is correctly imported
      ...
      {/* <button
  ref={mainbtnRef}
  className="hover:text-purple-900 relative bg-transparent py-2 px-4 text-white font-bold
             rounded-lg rounded-tr-[20px] rounded-tl-none
             before:absolute before:inset-0 before:bg-gradient-to-r before:from-sky-400 before:via-purple-500 before:to-orange-500
             before:rounded-lg before:rounded-tr-[20px] before:rounded-tl-none
             before:z-[-1] before:p-[2px]"
>
  Get Started
</button> */}
  ...
  ref={Featuresref}
  id="Feature"
  className="text-white font-serif text-center font-bold text-3xl"
>
  Features That meet your need
      ...
      <div
        className="absolute inset-0 bg-cover bg-center w-screen opacity-100"
      />
      <div className="absolute inset-0  opacity-90" />

      {/* Feature Cards */}
      <div className="relative grid grid-cols-1 text-white sm:grid-cols-2 gap-6 p-4 md:p-8 lg:p-12">
    
    {/* Your Data */}
    <div className="shadow-boxy float-in-right rounded-xl p-4 bg-white backdrop-filter backdrop-blur-lg bg-opacity-20">
      <h2 className="text-xl font-bold mb-2">Your Data</h2>
      <p>Easily manage and access your data in one place.</p>
      <div className="mt-4">
        <FaCloud className="h-8 w-8 text-gradient-blue-orange-purple" />
      </div>
    </div>
    ...
    <div className="shadow-boxy float-in-right rounded-xl p-4 bg-white backdrop-filter backdrop-blur-lg bg-opacity-20">
      ...
      <div className="mt-4">
        <FaShieldAlt className="h-8 w-8 text-gradient-blue-orange-purple" />
      </div>
    </div>

    {/* Issue Tracking */}
    <div className="shadow-boxy float-in-right rounded-xl p-4 bg-white backdrop-filter backdrop-blur-lg bg-opacity-20">
      <h2 className="text-xl font-bold mb-2">Issue Tracking</h2>
      <p>Easily track all the issues and workflows of your project.</p>
      <div className="mt-4">
        <FaFlag className="h-8 w-8 text-gradient-blue-orange-purple" />
      </div>
    </div>

    {/* Reports and Analytics */}
    <div className="shadow-boxy float-in-right rounded-xl p-4 bg-white backdrop-filter backdrop-blur-lg bg-opacity-20">
      <h2 className="text-xl font-bold mb-2">Reports and Analytics</h2>
      <p>Get detailed reports and analytics of your project.</p>
      <div className="mt-4">
        <FaChartBar className="h-8 w-8 text-gradient-blue-orange-purple" />
      </div>
    </div>
          ...
          <div
  id='features'
  className='grid grid-cols-1 md:grid-cols-2 mt-14 pr-28 pl-10 sm:pl-20 sm:pr-28 gap-4'
>
  {/* Content Column */}
  <div className='w-48 pl-4 rounded-lg'>
    <FaTicketAlt className="text-3xl text-white" />
    <p className='w-40 font-serif text-white'>Create task easily</p>

    <FaRobot className='text-3xl text-white ml-24' />
    <p className='flex justify-center text-center font-serif w-96 text-white'>
      Fully customize workflows
    </p>
  ...
  {/* Image Column */}
  <div className='flex justify-center items-center animate-pulse  px-10'>
  <img
      src={robot2}  // Ensure you import or reference the correct image path
...
<div
  className="mt-7 grid grid-cols-1 md:grid-cols-2 grid-flow-row rounded-2xl p-2 mb-12 ml-3 shadow-boxy text-white"
>
  {/* Text Content */}
  ...
  <img
      src={sample}
      alt="task details"
      className="lg:w-[32rem] lg:h-[25rem] md:w-[28rem] md:h-[28rem] rounded-xl sm:w-[20rem] sm:h-[20rem]"
    />

  </div>

  {/* Image Content */}
  <div className=" mt-8 ml-10 font-bold grid grid-flow-row justify-center text-center">
      <span className="text-white sm:text-base md:text-xl lg:text-2xl font-serif">
Our Aim      
    </span>

    <p className="mt-[-4rem] font-serif sm:text-sm md:text-sm lg:text-base">
      Sprinty is a leading project management tool designed to help teams plan,
      track, and manage their projects effortlessly. Our mission is to provide a
      seamless and efficient platform for teams to collaborate, stay organized,
      and achieve their project goals. With a focus on customization, security,
      and ease of use, Sprinty ensures that your team can work together
      effectively, no matter the project size or complexity.
    </p>
  </div>
</div>
<div
                
                className=' float-in-left mt-2 p-6 ml-10 grid grid-flow-row justify-center text-center grid-rows-3'
              >
  <h1 className='text-white font-bold sm:text-base md:text-xl lg:text-2xl font-serif '>Ready to get started?</h1>
  
  <p className='font-serif  text-white'>Discover the benefits of Sprinty today and start planning and managing your projects.</p>
<button ref={signbtnRef} className="hover:text-purple-900 relative bg-transparent  text-white font-bold
             rounded-lg rounded-tr-[20px] rounded-tl-none
             before:absolute before:inset-0 before:bg-gradient-to-r before:from-sky-400 before:via-purple-500 before:to-orange-500
             before:rounded-lg before:rounded-tr-[20px] before:rounded-tl-none
             before:z-[-1] before:p-[2px] lg:w-24 lg:ml-64 lg:mt-2 sm:ml-[14rem] md:ml-[16rem] text-danger_light font-sans">Sign in</button>  </div>
...
>
  {/* Text Content */}
  <div className="mt-1 ml-10 font-bold grid grid-flow-row justify-center text-center">
    <span className="text-white sm:text-base md:text-xl lg:text-2xl font-serif">
      About us
      {/* <img
        src={curve}
    ...
    <p className="font-serif sm:text-sm md:text-sm lg:text-base">
      Sprinty is a leading project management tool designed to help teams plan,
      track, and manage their projects effortlessly. Our mission is to provide a
      seamless and efficient platform for teams to collaborate, stay organized,
      and achieve their project goals. With a focus on customization, security,
    ...
    <a className="text-purple-900 underline" href="mailto:codewolf@gmail.com">
      codewolf@gmail.com
    </a>
  </div>
  ...
  <div className="flex justify-center items-center">
    <img
      src={robot}
      alt="task details"
      className="lg:w-[22rem] lg:h-[25rem] md:w-[28rem] md:h-[28rem] rounded-xl sm:w-[20rem] sm:h-[20rem]"
    />
  </div>
</div>
        ...
        <div className='flex justify-center '>
          ...
          <button className="ml-2 relative bg-gradient-to-r from-sky-400 via-purple-500 to-orange-500 text-white font-bold py-2 px-2 rounded-md hover:text-purple-950">
