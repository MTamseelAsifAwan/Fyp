...
const App = () => {
  return (
    ...
    <Container>
      <Row>
        <Col>
      <div className=' justify-center  grid grid-cols-1 items-center text-center flex-col sm:px-4 md:px-8 lg:px-12'>
        ...
        <div className='flex justify-center'>
          <p className='text-black_color font-bold flex justify-center mt-8 text-base text-center sm:text-sm md:text-base lg:text-xl'>
            Project management tool you need to plan and track work across every team.
          </p>
        </div>
        <div className='flex justify-center mt-6'>
          <button className='bg-purple-900 font-bold py-2 px-4 rounded-lg text-white'>Get Started</button>
        </div>
        </div>
        </div>
      </div>
      ...
      <div className='grid justify-center items-center grid-cols-1 grid-flow-col mt-14 '>
        <h3 className='text-black_color text-center font-bold text-3xl'>Features That meet your need</h3>
  ...
  <div className='shadow-lg rounded-xl p-4'>
    ...
    <p>Tailor the platform to fit your specific workflow and needs</p>
  </div>
  <div className='shadow-lg rounded-xl p-4'>
    ...
    <div className='shadow-lg rounded-xl p-4'>
      ...
      <p>Collaborate with your team easily and efficiently</p>
    </div>
    <div className='shadow-lg rounded-xl p-4'>
      ...
      <p>Get detailed reports and analytics of your project.</p>
          ...
          {/* features2 */}
<div className='grid grid-cols-1 mt-14 pr-28 pl-10 sm:pl-20 sm:pr-28 gap-4'>
<FaTicketAlt className="text-3xl text-purple-900 mb-[-1rem]" />
  <p className='w-40'>Create task easily</p>
  <FaRobot className=' text-3xl text-purple-900 ml-24 mb-[-1rem]'/>
  <p className='flex justify-center text-center w-96'>Fully coustomize workflows</p>
  <FaUsers className=' text-3xl text-button text-purple-900 ml-[11.5rem] mb-[-1rem] '/>
  <p className='flex justify-end text-end w-96'> Seamless team collaboration</p>

</div>
<br/>
<br/>
<Pricing/>
<div className='mt-12 p-6 ml-10 font-bold grid grid-flow-row justify-center text-center grid-rows-3 '>
  <h1 className='text-purple-900  sm:text-base md:text-xl lg:text-2xl'>Ready to get started?</h1>
  <p>Discover the benefits of Sprinty today and start planning and managing your projects.</p>
  <button className="bg-purple-900 border text-white border-none rounded-md grid w-24 items-center justify-center ml-28 mt-2 sm:ml-[14rem] md:ml-[16rem] text-danger_light font-sans">Sign in</button>
  </div>
 {/* About us */}
 <div className='grid grid-cols-2 grid-flow-row shadow-2xl rounded-2xl p-2 mb-12 ml-3'>
 <div className='about-us-section mt-1  ml-10 font-bold grid grid-flow-row justify-center text-center grid-rows-4'>
              <h1 className='text-purple-900 sm:text-base md:text-xl lg:text-2xl'>About Us</h1>
              <p className='text-black text-sm:text-sm md:text-sm lg:text-base mt-[-3rem]'>
            ...
            <div>
              <img src={taskdetails} alt="task details" className='w-[44rem] h-[28rem] rounded-xl ' />
            </div>
            </div>
      ...
      {/* footer */}
      <footer className='bg-black h-56 pt-3'>
  ...
  <p className='text-center text-white font-bold text-sm'>Copyright © 2023 Sprinty. All rights reserved.</p>
    <p className='text-center text-white font-bold text-sm'>Privacy Policy | Terms of Service</p>
    <p className='text-center text-white font-bold text-sm'>Contact Us</p>
    <p className='text-center text-white font-bold text-sm'>About Us</p>
